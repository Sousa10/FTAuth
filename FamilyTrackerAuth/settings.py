"""
Django settings for FamilyTrackerAuth project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-l&z4pk38)d#_w#uusaajy1zixgzk)2&$a_*uk#*!vb%u=p=zv!')
...
ROOT_URLCONF = 'FamilyTrackerAuth.urls'
...
# AUTH_USER_MODEL = 'LoginRegister.PersonM'
